...
(def longtext "ᠡᠷᠲᠡ ᠠᠷᠪᠠᠨ ᠬᠡᠳᠦᠨ ᠵᠢᠯ᠎ᠦᠨ ᠡᠮᠦᠨ᠎ᠡ᠂ ᠨᠢᠭᠡ ᠥᠨᠳᠦᠷ ᠰᠡᠭᠦᠳᠡᠷᠲᠡᠢ ᠪᠣᠯᠤᠭᠰᠠᠨ ᠡᠪᠦᠭᠡᠨ ᠨᠢᠭᠡ ᠬᠦᠦ᠎ᠲᠡᠢ ᠡᠨᠡᠭᠦᠷ ᠬᠣᠨᠢ ᠬᠠᠷᠢᠭᠤᠯᠵᠤ ᠶᠠᠪᠤᠭᠰᠠᠨ ᠪᠠᠢᠵᠠᠢ᠃ ᠲᠡᠷᠡ ᠬᠦᠦ᠂ ᠡᠪᠦᠭᠡᠨ᠎ᠦ ᠰᠡᠳᠭᠢᠯ᠎ᠳᠦ ᠨᠠᠷᠠ ᠪᠣᠯᠵᠤ ᠶᠠᠪᠤᠭᠰᠠᠨ ᠭᠡᠨ᠎ᠡ ᠰᠢᠤ᠃ ᠴᠢᠩᠭᠢᠭᠡᠳ ᠡᠪᠦᠭᠡᠨ ᠡᠨᠡ ᠬᠦᠦ᠎ᠳᠦ ᠨᠢᠭᠡ ᠨᠠᠰᠤᠨ᠎ᠤ ᠰᠠᠨᠠᠵᠤ ᠰᠠᠷᠪᠠᠢᠵᠤ ᠶᠠᠪᠤᠭᠰᠠᠨ ᠠᠵᠢᠯ ᠦᠢᠯᠡ᠎ᠪᠡᠨ ᠨᠠᠢᠳᠠᠵᠤ᠂ ᠠᠮᠢᠳᠤ ᠳᠡᠭᠡᠷ᠎ᠡ᠎ᠪᠡᠨ ᠦᠵᠡᠵᠦ ᠳᠡᠢᠯᠬᠦ᠎ᠦᠭᠡᠢ᠎ᠴᠦ᠂ ᠦᠬᠦᠭᠰᠡᠨ ᠬᠣᠢᠨ᠎ᠠ᠎ᠪᠠᠨ ᠦᠵᠡᠨ᠎ᠡ ᠭᠡᠵᠦ᠂ ᠬᠡᠭᠦᠷ᠎ᠢᠶᠡᠨ ᠡᠨᠳᠡ ᠣᠷᠤᠰᠢᠭᠤᠯᠬᠤ᠎ᠶᠢ ᠬᠥᠮᠦᠰ᠎ᠲᠦ ᠵᠠᠬᠢᠭᠰᠠᠨ ᠪᠠᠢᠵᠠᠢ᠃")
